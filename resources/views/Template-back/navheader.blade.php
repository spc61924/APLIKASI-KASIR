...
<div class="main-header side-header sticky nav nav-item bg-primary">
    <div class="container-fluid main-container">
                        ...
                        <div class="dropdown main-profile-menu nav nav-item nav-link">
                            ...
                            <div class="dropdown-menu">
                                <div class="main-header-profile header-img">
                                    ...
                                    <h6 style="font-family: Verdana, Geneva, Tahoma, sans-serif">@auth {{ auth()->user()->name }} @endauth</h6>
                                    <span>@auth {{ auth()->user()->role }} @endauth</span>
                                </div>
                                <a class="dropdown-item" href="{{ route('logout') }}"><i style="margin-left: 50px" class="fas fa-sign-out-alt"></i>SIGN OUT</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex header-setting-icon"><a class="nav-link icon demo-icon"href="javascript:void(0);"><i class="fe fe-settings  fe-spin"></i></a></div>
    </div>
</div>
<!-- /main-header -->
