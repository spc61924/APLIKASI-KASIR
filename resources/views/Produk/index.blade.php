...
<div class="container">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div>
            <h4 class="content-title mb-2">PRODUK MASUK</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                    <li class="breadcrumb-item text-white active">Produk Masuk</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex my-auto btn-list justify-content-end">
                                <a href="{{ route('create-produk') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah</a>
