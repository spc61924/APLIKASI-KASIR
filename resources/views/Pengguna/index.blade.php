                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex my-auto btn-list justify-content-end">
                                <a href="{{ route('create-pengguna') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah</a>
                         ...
                         id="tbl_list2" class="table table-sm table-striped table-bordered tx-14" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>{{ $item->role }}</th>
                                    <td>
                                        <a href="{{ route('edit-pengguna', $item) }}" class="btn btn-info btn-sm" title="Edit"><i class="fe fe-edit"></i></a>
                                        <a href="{{ route('delete-pengguna', $item) }}" class="btn btn-danger btn-sm" title="Hapus" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')"><i class="fe fe-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
