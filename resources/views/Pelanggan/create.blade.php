...
@section('content')
@section('title', 'Form Input Pelanggan')
<!-- container opened -->
<div class="container">
    <!-- breadcrumb -->
    <div class="breadcrumb-header justify-content-between">
        <div>
            <h4 class="content-title mb-2">FORM INPUT PELANGGAN</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="">Data Pelanggan</a></li>
                    <li class="breadcrumb-item text-white active">Form Input Pelanggan</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <form action="{{ route('store-pelanggan') }}" method="post">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="" type="text" name="nama_pelanggan" value="{{ old('nama_pelanggan') }}">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="" type="text" name="alamat" value="{{ old('alamat') }}">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="" type="number" name="nomor_telepon" value="{{ old('nomor_telepon') }}">
                                </div>
                            </div>
